    ...
    <div class="container">
        <div class="row justify-content-center pt-5 mt-5 m-1">
            <div class="col-md-6 col-sm-8 col-xl-4 col-lg-5 formulario">
                <form method="POST" action="<?php echo base_url();?>/index.php/ProyectoA/login" role="form" onsubmit="return seguridad();">
                    ...
                    <div class="form-group mx-sm-4 pt-4">
                       <input type="submit" class="ingresar ingresar-block" value="Iniciar sesión" name=""></a>
                    </div>

                    <div class="form-group mx-sm-4">
                        <a href="registroA"><input type="button" class="ingresar2 ingresar-block" value="Crear cuenta" name=""></a>
                    </div>
                </form>
            </div>
