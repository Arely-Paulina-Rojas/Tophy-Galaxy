            ...
            <div class="espacio">
                <div class="container">
                <h1 class="huno">Retro: Axiom Verge</h1>
                    ...
                    <br>
                    <img src="<?php echo base_url(); ?>/assets/images/av1.jpg" class="rounded img-fluid mx-auto d-block" width="650" height="300">        
                    <p>
                    <br>
                    <p>¡Hola! Qué bueno que llegaste una vez más a esta sección. Esta semana hablaremos de otro título que no salió hace mucho, pero que sí nos remonta a esos maravillosos principios de los años 90 en la era del gaming del cartucho.
                    <br><br>
                    ...
                    <br><br>
                    <img src="<?php echo base_url(); ?>/assets/images/avv1.jpg" class="rounded img-fluid mx-auto d-block" width="650" height="300">    
                    <br><br>
                    ...
                    <br><br>
                    <img src="<?php echo base_url(); ?>/assets/images/avv2.jpg" class="rounded img-fluid mx-auto d-block" width="650" height="300"> 
                    <br><br>
                    ...
                    <br><br>
                    <img src="<?php echo base_url(); ?>/assets/images/avv3.jpg" class="rounded img-fluid mx-auto d-block" width="650" height="300"> 
                    <br><br>
