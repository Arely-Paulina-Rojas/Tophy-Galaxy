            <div class="espacio">
                <div class="container">
                <h1 class="huno">RESEÑA - Sound of Metal</h1>
                    ...
                    <br>
                    <img src="<?php echo base_url(); ?>/assets/images/rp2.jpg" class="rounded img-fluid mx-auto d-block" width="650" height="300">        
                    <p>
                    <br>
                    ...
                    <br><br>
                    Para un adicto como Ruben que lleva cuatro años limpio -los mismos que lleva de relación con Lou- su reacción inicial su reciente discapacidad es un “fix” o solución inmediata, ignorando que esta bien podría tratarse de su nueva realidad. No hay manera de recuperar la audición que ya ha perdido, sea por su exposición a la música de alto volumen o a alguna enfermedad autoimmune, le advierte el mismo doctor que le orienta sobre una costosa operación que le devolvería su sentido por medio de un implante coclear. Rápidamente, el procedimiento quirúrgico se convierte en el único norte de este músico en un estado depresivo que aumenta con la rapidez que va perdiendo lo que le queda de audición.
                    <br><br>
                    <img src="<?php echo base_url(); ?>/assets/images/rp21.jpg" class="rounded img-fluid mx-auto d-block" width="650" height="300">  
                    <br><br>
                    Cuando Ruben pierde su audición, la audiencia lo experimenta con él, mezclando el irritable tinnitus con el zumbido que resulta de las pocas ondas de sonido que sus oídos aún pueden reconocer. El estilo narrativo añade a la desesperación del protagonista y aquellos que intentan ayudarlo, evitando el uso de subtítulos en momentos críticos de la historia. Pero Marder tiene algo que decir más allá de utilizar este estilo como un “gimmick” para generar atención. Con la ayuda de una comunidad de sordos que busca mejorar el estilo de vida de personas sordas en lugar de buscar una solución, Ruben comienza su búsqueda de un nuevo propósito, implementando su conocimiento de percusión y una innata habilidad de trabajar con niños. 
                    <br><br>
                    Donde “Sound of Metal” encuentra uno de sus mayores logros, es reafirmando que esto no es un “tear jerker” confeccionado para hacer llorar a la audiencia. Presentando a Ruben como una figura imperfecta con un pasado oscuro, pero sobre todo, como un la persona perseverante, el guion de Darius y su hermano Abraham nunca te invita a sentir lástima por él, sino a acompañarlo en esta nueva etapa de su vida. Pero el guion no es necesariamente impecable, con varias secuencia apresuradas que se habrían beneficiado de un poco más de tiempo. 
                    <br><br>
                    Con Lou (una excelente Olivia Cooke), Marder explora el tipo de relación dañina en que ambas partes viven convencidas de que son mejores personas cuando están el uno con el otro. La idea de que otra persona es responsable de salvarte la vida es un tema recurrente en “Sound of Metal”, y una de las percepciones tóxicas que Joe (Paul Raci), el nuevo mentor de Ruben en esta comunidad de sordos, busca erradicar de su vida. 
                    <br><br>
                    Ahmed, quien se ha dado a conocer en Hollywood con roles en “Nightcrawler” y “Rogue One: A Star Wars Story”, fortalece su impresionante repertorio con su mejor actuación hasta el día de hoy, una merecedora de toda la atención de la Academia. Con temas de pérdida, superación y adicción adornados con un innovador diseño de sonido que desatará importantes conversaciones sobre la inclusividad, “Sound of Metal” termina siendo una propuesta imposible de resistir.
                    <br><br>
