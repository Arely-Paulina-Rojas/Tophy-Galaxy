...
<body>
	...
	<div>
		<header>
			<nav>
                <a href="<?php echo base_url();?>/index.php/Proyecto/index" class="banner "><img class="logo" src="<?php echo base_url(); ?>/assets/images/logo.png"></a>
                
                	<div class="contenedorDiv">
                		<form class="barra" method="POST" action="<?php echo base_url();?>/index.php/Proyecto/buscar" role="form">
                	...
                	<div class="contenedorDiv2">
  						...
  						<div class="dropdown-menu">
    						<a class="dropdown-item" href="<?php echo base_url();?>/index.php/Proyecto/inicioSesion">Iniciar sesión</a>
    						<a class="dropdown-item" href="<?php echo base_url();?>/index.php/Proyecto/registro">Registrarse</a>
                            <a class="dropdown-item" href="<?php echo base_url();?>/index.php/Proyecto/perfil">Perfil</a>
                            <a class="dropdown-item" href="<?php echo base_url();?>/index.php/Proyecto/salir">Salir</a>
  						</div>
					</div>
