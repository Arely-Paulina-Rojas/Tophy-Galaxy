    ...
    <div class="container">
        <div class="row justify-content-center pt-3.5 mt-5 m-1">
            <div class="col-md-6 col-sm-8 col-xl-4 col-lg-5 formulario">
                <form method="POST" action="<?php echo base_url();?>/index.php/Proyecto/index" role="form" onsubmit="return seguridad();">
                    ...
                    <div class="form-group mx-sm-4">
                        ...
                        <a href="<?php echo base_url();?>/index.php/Proyecto/inicioSesion"><input type="button" class="ingresar2 ingresar-block" value="Iniciar sesión" name=""></a>
