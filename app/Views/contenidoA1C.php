   <div class="espacio">
                <div class="container">
                <h1 class="huno">Los mejores Marvel Must Have. Miles Morales: Spiderman. Origen</h1>
                    ...
                    <br>
                    <img src="<?php echo base_url(); ?>/assets/images/ac1.jpg" class="rounded img-fluid mx-auto d-block" width="650" height="300">        
                    <p>
                    <br>
                    ...
                    <br><br>
                    <img src="<?php echo base_url(); ?>/assets/images/ac11.jpg" class="rounded img-fluid mx-auto d-block" width="650" height="300">
                    <br><br>
