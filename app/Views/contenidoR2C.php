            <div class="espacio">
                <div class="container">
                <h1 class="huno">RESEÑA - Superman Corazones Perdidos</h1>
                    ...
                    <br>
                    <img src="<?php echo base_url(); ?>/assets/images/rc2.jpg" class="rounded img-fluid mx-auto d-block" width="650" height="300">        
                    <p>
                    <br>
                    ...
                    <br><br>
                    <img src="<?php echo base_url(); ?>/assets/images/rc21.jpg" class="rounded img-fluid mx-auto d-block" width="650" height="300">  
                    <br><br>
                    Traci es una joven con un cierto grado de poder mágico y una enorme empatía que se esfuerza por ayudar a los vecinos de su barrio contra la amenaza invisible que les acecha: un parasito mágico, al que Traci denomina “rompecorazones”, y está invadiendo poco a poco el marginal barrio de Hell’s Heart.
                    <br><br>
                    ...
                    <br><br>
                    <img src="<?php echo base_url(); ?>/assets/images/rc22.jpg" class="rounded img-fluid mx-auto d-block" width="650" height="300"> 
                    <br><br>
