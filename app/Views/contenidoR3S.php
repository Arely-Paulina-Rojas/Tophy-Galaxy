             <div class="espacio">
                <div class="container">
                <h1 class="huno">RESEÑA - Soulmates</h1>
                   ...
                   <br><br>
                   <img src="<?php echo base_url(); ?>/assets/images/rs31.jpg" class="rounded img-fluid mx-auto d-block" width="650" height="300"> 
                   <br><br>
                   ...
                   <br><br>
                   Cada episodio de la serie tiene un tono distinto: algunos son más dramáticos, como sucede con el inicial, mientras que otros se meten en el terreno del thriller utilizando el suspense y explorando situaciones más complejas: ¿cómo podría alguien aprovecharse de este descubrimiento para cobrarse una venganza retorcida? ¿Qué pasa si la persona a la que estás predestinado a amar no es quien parece?
                   <br><br>
                   ...
                   <br><br>
                   <h4 class="huno">LO ÚNICO CIERTO ES LA MUERTE, LOS IMPUESTOS Y EL AMOR</h4>
                   <hr class="lineaDiv">
                   Soulmates cuenta con un elenco de lo más interesante que hace que las interpretaciones sean, además de la historia, otro fuerte foco de atracción: encontraréis en ella a la magnética Sarah Snook (Succession), a Bill Skarsgård (Castle Rock), a Charlie Heaton (Stranger Things) o a la española Laia Costa (Foodie Love).
                   <br><br>
