            ...
            <div class="espacio">
                <div class="container">
                <h1 class="huno">NVIDIA presenta su mayor salto generacional con la serie GeForce RTX 30 de GPUs</h1>
                    ...
                    <br>
                    <img src="<?php echo base_url(); ?>/assets/images/at2.jpg" class="rounded img-fluid mx-auto d-block" width="650" height="300">        
                    <p>
                    <br>
                    <p>NVIDIA develó hoy su serie GeForce RTX 30 de GPUs, impulsada por la arquitectura Ampere, lo que significa el mayor salto generacional en la historia de GeForce.
                    <br><br>
                    ...
                    <br><br>
                    <img src="<?php echo base_url(); ?>/assets/images/at21.jpg" class="rounded img-fluid mx-auto d-block" width="650" height="300">    
                    <br><br>
                    ...
                    <br><br>
                    <img src="<?php echo base_url(); ?>/assets/images/at22.png" class="rounded img-fluid mx-auto d-block" width="650" height="300"> 
                    <br><br>
                    ...
                    <br><br>
                    <img src="<?php echo base_url(); ?>/assets/images/at23.png" class="rounded img-fluid mx-auto d-block" width="650" height="300"> 
                    <br><br>
                    Por tiempo limitado, los jugadores que compren una nueva GPU o un sistema con una unidad gráfica de la serie GeForce RTX 30 recibirán un código de descarga para PC de Watch Dogs: Legion.
                    </p>
                    <br><br>
