   <div class="espacio">
                <div class="container">
                <h1 class="huno">RESEÑA - The Last God</h1>
                    ...
                    <br>
                    <img src="<?php echo base_url(); ?>/assets/images/rc3.jpeg" class="rounded img-fluid mx-auto d-block" width="650" height="300">        
                    <p>
                    <br>
                    ...
                    <br><br>
                    <img src="<?php echo base_url(); ?>/assets/images/rc31.jpg" class="rounded img-fluid mx-auto d-block" width="650" height="300">
                    <br><br>
                    ...
                    <br><br>
                    <img src="<?php echo base_url(); ?>/assets/images/rc32.jpg" class="rounded img-fluid mx-auto d-block" width="650" height="300">
                    <br><br>
                    Una obra muy atractiva visualmente, con un Federici muy talentoso y un equipo creativo capaz de traer a la manifestación las ideas de Johnson de manera espectacular. Sin embargo, lo atractivo de la obra, si cabe reside en una lectura bajo sus capas aparentemente superficiales, recordándonos una antigua afirmación de Eliphas Levi:
                    <br>
                    —¿Qué es la Magia si no el arte de servirse de las fuerzas ocultas?
                    <br>
                    A la cual podemos sumar: ¿Y qué más oculto que nuestros pensamientos y emociones más íntimos?
                    </p>
                    <br><br>
